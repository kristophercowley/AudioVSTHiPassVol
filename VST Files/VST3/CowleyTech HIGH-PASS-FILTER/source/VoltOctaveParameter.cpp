...
ParamValue VoltOctaveParameter::toPlain(ParamValue valueNormalized) const
{
	valueNormalized = calcVoltOctavePluginValue(valueNormalized);
	return valueNormalized*(getMax() - getMin()) + getMin();
}
